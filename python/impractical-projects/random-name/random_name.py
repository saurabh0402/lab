"""
A command line tool to generate funny names using the tuple
...
def main():
    """
    The core logic of the code which keeps generating the name until
    the user is happy.
    """
    first = (
        ...
        'Pitchfork Ben', 'Potato Bug', 'Pushmeet','Rock Candy', 'Schlomo', 'Scratchensniff',
        'Scut', "Sid 'The Squirts'", 'Skidmark', 'Slaps', 'Snakes', 'Snoobs', 'Snorki',
    ...
    while True:
        ...
        try_again = input('Try Again? (Press q to quite): ')
